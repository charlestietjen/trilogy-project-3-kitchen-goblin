...
export const Nav = () => {
    return (
        <Flex backdropFilter={'auto'} backdropBlur={'0.1em'} borderTop='solid gray thin' bg='blackAlpha.400' color='whiteAlpha' w='100%' h='100%' minH={'fit-content'} align='center' justifyContent={'space-evenly'}>
            {Auth.loggedIn() ? (
                <>
